...
DATA_PATHS=["../crypto_preprocessing/step4_cutdata/","../crypto_preprocessing/step4_cutdata_indicators/","../crypto_preprocessing/step5_horizontal/"]
...
try:
    os.mkdir(out_path+"/"+"final")
except OSError:
    print("Creation of the directory %s failed" % out_path+"/"+"result")
else:
